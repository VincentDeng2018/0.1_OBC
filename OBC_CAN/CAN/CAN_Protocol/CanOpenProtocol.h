...
* Includes
**********************************************************************************************/
#ifndef _CANOPENPROTOCOL_H
#define _CANOPENPROTOCOL_H
...
class CanProtocol
{
    ...
    UINT16 XcpSendData(stCanMessage_t *pCanMsg);
    void CreatCanThread(void *param);
    void CanOpenTxRequest(stCanMessage_t CanOpenRequest);
};
