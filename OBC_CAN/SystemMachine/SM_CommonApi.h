...
typedef struct
{
    ...
    uint32_t EnterSimulationMode: 1;
    uint32_t BattCanActive: 1; /* means we received CAN open Frames */
...
extern uint16_t PWM_ICmdLast_x10;
extern uint16_t PWM_UCmdLast_x10;
/**********************************************************************************************
* Global Functions
**********************************************************************************************/
