...
#define MSD0_card_enable()      GPIOD->BRR = GPIO_Pin_2//GPIOA->BRR = GPIO_Pin_4//GPIO_ResetBits(GPIOA,GPIO_Pin_4)
#define MSD0_card_disable()     GPIOD->BRR = GPIO_Pin_2//GPIOA->BSRR = GPIO_Pin_4//GPIO_SetBits(GPIOA,GPIO_Pin_4)
#define MSD0_card_power_on()
#define MSD0_card_insert()       1//GPIOB->IDR & GPIO_Pin_0//GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_0)
//
//
///* Private typedef -----------------------------------------------------------*/
//enum _CD_HOLD
...
inline int MSD0_spi_read_write(uint8_t data);
