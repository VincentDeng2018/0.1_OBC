...
UNS32 CiA418_obj1000 = 0x1A2;    /* 418*/
subindex CiA418_Index1000[] = 
{
    { RO, uint32, sizeof (UNS32), (void*)&CiA418_obj1000 }
};


/* index 0x1001 :   Error Register. */
UNS8 CiA418_obj1001 = 0x0;   /* 0 */
subindex CiA418_Index1001[] = 
{
    { RO, uint8, sizeof (UNS8), (void*)&CiA418_obj1001 }
};

/* index 0x1002 :   Not support. */
/* index 0x1003 :   Not support. */

/* index 0x1005 :   Not support. */
...
/* index 0x1012 :   COB-ID TIME message. */
subindex TestSlave_Index1012[] = 
{
    { RW, uint32, sizeof (UNS32), (void*)&stObj1012 }
};
...
UNS32 TestSlave_obj1400_COB_ID_used_by_PDO = 0x140; /* 384 */
...
UNS8 TestSlave_obj1400_SyncStartVal = 0x0;
subindex TestSlave_Index1400[] = 
{
    { RO, uint8, sizeof (UNS8), (void*)&TestSlave_highestSubIndex_obj1400 },                //0
    { RW, uint32, sizeof (UNS32), (void*)&TestSlave_obj1400_COB_ID_used_by_PDO },           //1
    { RW|TO_BE_SAVE, uint8, sizeof (UNS8), (void*)&TestSlave_obj1400_Transmission_Type },   //2
    { RW|TO_BE_SAVE, uint16, sizeof (UNS16), (void*)&TestSlave_obj1400_Inhibit_Time },      //3
    { RW, uint8, sizeof (UNS8), (void*)&TestSlave_obj1400_Compatibility_Entry },            //4
    { RW, uint16, sizeof (UNS16), (void*)&TestSlave_obj1400_Event_Timer },                  //5
    { RW, uint8, sizeof (UNS8), (void*)&TestSlave_obj1400_SyncStartVal}                     //6
};


UNS8 TestSlave_highestSubIndex_obj1600 = 2; /* number of subindex - 1*/
UNS32 TestSlave_obj1600_AppObj1 = 0x60100010;
UNS32 TestSlave_obj1600_AppObj2 = 0x60000008;

subindex TestSlave_Index1600[] = 
{
    { RO, uint8, sizeof (UNS8), (void*)&TestSlave_highestSubIndex_obj1400 },                //0
    { RW, uint32, sizeof (UNS32), (void*)&TestSlave_obj1600_AppObj1 },           //1
    { RW, uint32, sizeof (UNS32), (void*)&TestSlave_obj1600_AppObj2 }            //2
};
...
UNS8 TestSlave_obj1800_SyncStartVal = 0x0;
...
subindex TestSlave_Index1800[] = 
{
    ...
    { RW, uint8, sizeof (UNS8), (void*)&TestSlave_obj1800_SyncStartVal }
};
...
UNS32 TestSlave_obj1A00_AppObj1 = 0x60010008;

subindex TestSlave_Index1A00[] = 
{
    { RO, uint8, sizeof (UNS8), (void*)&TestSlave_highestSubIndex_obj1A00 },                //0
    { RW, uint32, sizeof (UNS32), (void*)&TestSlave_obj1A00_AppObj1 }             //1
};
...
/***************** Application ******************/
/* battery status */
UNS8 OBJ6000_BattStatus = 0u;

subindex TestSlave_Index6000[] = 
{
    { RW, uint8, sizeof (INTEGER8), (void*)&OBJ6000_BattStatus }
};

/* charger status */
UNS8 OBJ6001_ChargerStatus = 0u;

subindex TestSlave_Index6001[] = 
{
    { RW, uint8, sizeof (INTEGER8), (void*)&OBJ6000_BattStatus }
};
...
/* battery temperature */
UNS8 OBJ6010_BattTemperature = 0u;

subindex TestSlave_Index6010[] = 
{
    { RW, uint16, sizeof (INTEGER16), (void*)&OBJ6010_BattTemperature }
};


/* battery parameter */
UNS8 OBJ6020_HighestSubIndex = 4u;
UNS16 OBJ6020_BattType = 0u;
UNS16 OBJ6020_AhCap = 0u;
UNS16 OBJ6020_MaxChgCurrent = 0u;
UNS16 OBJ6020_CellNum = 0u;

subindex TestSlave_Index6020[] = 
{
    { RW, uint8, sizeof (INTEGER8), (void*)&OBJ6020_HighestSubIndex },
    { RW, uint16, sizeof (INTEGER16), (void*)&OBJ6020_BattType },
    { RW, uint16, sizeof (INTEGER16), (void*)&OBJ6020_AhCap },
    { RW, uint16, sizeof (INTEGER16), (void*)&OBJ6020_MaxChgCurrent },
    { RW, uint16, sizeof (INTEGER16), (void*)&OBJ6020_CellNum }
};

/* battery serial number */
UNS8 OBJ6030_HighestSubIndex = 3u;
UNS32 OBJ6030_SerialNum0 = 0u;
UNS32 OBJ6030_SerialNum1 = 0u;
UNS32 OBJ6030_SerialNum2 = 0u;

subindex TestSlave_Index6030[] = 
{
    { RW, uint8, sizeof (INTEGER8), (void*)&OBJ6030_HighestSubIndex },
    { RW, uint32, sizeof (INTEGER32), (void*)&OBJ6030_SerialNum0 },
    { RW, uint32, sizeof (INTEGER32), (void*)&OBJ6030_SerialNum1 },
    { RW, uint32, sizeof (INTEGER32), (void*)&OBJ6030_SerialNum2 }
};


/* battery ID */
UNS8 OBJ6031_HighestSubIndex = 3u;
UNS32 OBJ6031_ID0 = 0u;
UNS32 OBJ6031_ID1 = 0u;
UNS32 OBJ6031_ID2 = 0u;
UNS32 OBJ6031_ID3 = 0u;

subindex TestSlave_Index6031[] = 
{
    { RW, uint8, sizeof (INTEGER8), (void*)&OBJ6031_HighestSubIndex },
    { RW, uint32, sizeof (INTEGER32), (void*)&OBJ6031_ID0 },
    { RW, uint32, sizeof (INTEGER32), (void*)&OBJ6031_ID1 },
    { RW, uint32, sizeof (INTEGER32), (void*)&OBJ6031_ID2 },
    { RW, uint32, sizeof (INTEGER32), (void*)&OBJ6031_ID3 }
};

/* Vehicle serial number */
UNS8 OBJ6040_HighestSubIndex = 3u;
UNS32 OBJ6040_SerialNum0 = 0u;
UNS32 OBJ6040_SerialNum1 = 0u;
UNS32 OBJ6040_SerialNum2 = 0u;
UNS32 OBJ6040_SerialNum3 = 0u;

subindex TestSlave_Index6040[] = 
{
    { RW, uint8, sizeof (INTEGER8), (void*)&OBJ6040_HighestSubIndex },
    { RW, uint32, sizeof (INTEGER32), (void*)&OBJ6040_SerialNum0 },
    { RW, uint32, sizeof (INTEGER32), (void*)&OBJ6040_SerialNum1 },
    { RW, uint32, sizeof (INTEGER32), (void*)&OBJ6040_SerialNum2 },
    { RW, uint32, sizeof (INTEGER32), (void*)&OBJ6040_SerialNum3 }
};

/* Vehicle ID */
UNS8 OBJ6041_HighestSubIndex = 3u;
UNS32 OBJ6041_ID0 = 0u;
UNS32 OBJ6041_ID1 = 0u;
UNS32 OBJ6041_ID2 = 0u;
UNS32 OBJ6041_ID3 = 0u;

subindex TestSlave_Index6041[] = 
{
    { RW, uint8, sizeof (INTEGER8), (void*)&OBJ6041_HighestSubIndex },
    { RW, uint32, sizeof (INTEGER32), (void*)&OBJ6041_ID0 },
    { RW, uint32, sizeof (INTEGER32), (void*)&OBJ6041_ID1 },
    { RW, uint32, sizeof (INTEGER32), (void*)&OBJ6041_ID2 },
    { RW, uint32, sizeof (INTEGER32), (void*)&OBJ6041_ID3 }
};

/* Object 6050h: Cumulative total Ah charge */
UNS32 OBJ6050_CumulativeTotal_AH = 0;
subindex TestSlave_Index6050[] = 
{
    { RW, uint32, sizeof (INTEGER32), (void*)&OBJ6050_CumulativeTotal_AH }
};

/* Object 6051h: Ah expended since last charge, uinit is 0.125AH */
UNS16 OBJ6051_LastExpended_0_125_AH = 0;
subindex TestSlave_Index6051[] = 
{
    { RW, uint16, sizeof (INTEGER16), (void*)&OBJ6051_LastExpended_0_125_AH }
};

/* Object 6052h: Ah returned during last charge, uinit is 0.125AH */
UNS16 OBJ6052_LastChg_0_125_AH = 0;
subindex TestSlave_Index6052[] = 
{
    { RW, uint16, sizeof (INTEGER16), (void*)&OBJ6052_LastChg_0_125_AH }
};

/* Object 6053h: Ah since last equalization, uinit is 0.125AH */
UNS16 OBJ6053_LastEqual_0_125_AH = 0;
subindex TestSlave_Index6053[] = 
{
    { RW, uint16, sizeof (INTEGER16), (void*)&OBJ6053_LastEqual_0_125_AH }
};

/* Object 6054h: Date of last equalization */
UNS8  OBJ6054_SubHighestIndex = 2u;
UNS16 OBJ6054_MinuteOfLastEqual = 0;
UNS16 OBJ6054_DayOfLastEqual = 0;
subindex TestSlave_Index6054[] = 
{
    { RW, uint8, sizeof (INTEGER8), (void*)&OBJ6054_SubHighestIndex },
    { RW, uint16, sizeof (INTEGER16), (void*)&OBJ6054_MinuteOfLastEqual },
    { RW, uint16, sizeof (INTEGER16), (void*)&OBJ6054_DayOfLastEqual }
};


/* Object 6060h: Battery voltage */
UNS32 OBJ6060_BatteryVolts_Q10V = 0;
subindex TestSlave_Index6060[] = 
{
    { RW, uint16, sizeof (INTEGER16), (void*)&OBJ6060_BatteryVolts_Q10V }
};

/* Object 6070h: Charge current requested */
UNS32 OBJ6070_ChargeCurrntRequest_Q4A = 0;
subindex TestSlave_Index6070[] = 
{
    { RW, uint16, sizeof (INTEGER16), (void*)&OBJ6070_ChargeCurrntRequest_Q4A }
};


/* Object 6080h: Charger state of charge, unit is 1% */
UNS8 OBJ6080_ChargeSOC = 0xFF;
subindex TestSlave_Index6080[] = 
{
    { RW, uint8, sizeof (INTEGER8), (void*)&OBJ6080_ChargeSOC }
};


/* Object 6081h: Battery state of charge, unit is 1% */
UNS8 OBJ6081_BatterySOC = 0xFF;
subindex TestSlave_Index6081[] = 
{
    { RW, uint8, sizeof (INTEGER8), (void*)&OBJ6081_BatterySOC }
};


/* Object 6090h: Water level status */
UNS8 OBJ6090_WaterLevelStatus = 0;
subindex TestSlave_Index6090[] = 
{
    { RW, uint8, sizeof (INTEGER8), (void*)&OBJ6090_WaterLevelStatus }
};
