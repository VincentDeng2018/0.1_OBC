...
@par Hardware and Software environment 
  ...
  - STM322xG-EVAL Setup
    ...
    - For loopback mode test: 
		 - remove RS232 cable on CN16 and connect directly USART TX and RX pins: 
		   PC10 and PC11 (with a cable or a jumper)
	     - PC10 is connected to pin 36 on CN4 Connector
         - PC11 is connected to pin 35 on CN4 Connector
    ...
    - Use CN15  connector to connect the board to host when using USB OTG HS-IN-FS peripheral
      Note that some FS signals are shared with the HS ULPI bus, so some PCB rework is needed.
        ...
        - Use CN8 connector to connect the board to PC (or to another evaluation board) over 
          RS232 (USART) serial cable.
        - For loopback mode test: remove RS232 cable on CN8 and connect directly USART
          TX and RX pins: PA9 and PA10 (with a cable or a jumper) 	  
