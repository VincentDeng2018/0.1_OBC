...
#error "Missing define: Evaluation board (ie. USE_STM322xG_EVAL)"
  ...
  LCD_LOG_SetHeader((uint8_t *) " Binary image template ");
  LCD_UsrLog("> Systick template example started.\n");
  LCD_LOG_SetFooter((uint8_t *) "     Binary image template ");
  ...
  /* Set the Vector Table base location at the application start address (this
   * is already done in system_stm32fxxx.c file) */
  /* #ifdef STM32F2XX */
