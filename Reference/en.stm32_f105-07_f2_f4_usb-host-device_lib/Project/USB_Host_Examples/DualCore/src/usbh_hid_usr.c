...
*/
/*--------------- LCD Messages ---------------*/
uint8_t MSG_HOST_INIT[] = ">Port1:Host Library Initialized\n";
uint8_t MSG_HID_DEV_ATTACHED[] = ">Port1:Device Attached\n";
uint8_t MSG_HID_DEV_DISCONNECTED[] = ">Port1:Device Disconnected\n";
uint8_t MSG_HID_DEV_ENUMERATED[] = ">Port1:Enumeration completed\n";
uint8_t MSG_HID_DEV_HIGHSPEED[] = ">Port1:High speed device detected\n";
uint8_t MSG_HID_DEV_FULLSPEED[] = ">Port1:Full speed device detected\n";
uint8_t MSG_HID_DEV_LOWSPEED[] = ">Port1:Low speed device detected\n";
uint8_t MSG_HID_DEV_ERROR[] = ">Port1:Device fault \n";
uint8_t MSG_HID_CLASS[] = ">Port1:HID device connected\n";

uint8_t USB_HID_MouseStatus[] = ">Port1:HID Demo Device : Mouse\n";
uint8_t USB_HID_KeybrdStatus[] = ">Port1:HID Demo Device : Keyboard\n";
uint8_t MSG_UNREC_ERROR[] = ">Port1:UNRECOVERED ERROR STATE\n";
/**
* @}
*/
...
void USR_MOUSE_ProcessData(HID_MOUSE_Data_TypeDef * data)
{
  ...
  else
  {
    sprintf(temp, "> %02xh %02xh %02xh %02xh\n", HID_Machine.buff[0],
            HID_Machine.buff[1], HID_Machine.buff[2], HID_Machine.buff[3]);
    LCD_DbgLog(temp);
